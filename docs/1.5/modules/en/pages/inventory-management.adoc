...
The {product-name} operator can hold an inventory of machines and
...
By default, {product-name} machines will attempt a registration update every 24 hours to update labels and annotations.
...
`MachineRegistration` holds information on how to install, reset, and configure all connected {product-name} machines.
