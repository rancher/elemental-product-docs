...
Follow this guide to restore an {product-name} configuration from a backup with Rancher.
...
You first have to follow this xref:backup.adoc[documentation] to do a backup of {product-name} resources.

== Restore the {product-name} configuration with rancher-backup operator
