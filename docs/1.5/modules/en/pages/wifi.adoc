...
This is possible by using a cloud-config definition in the https://documentation.suse.com/cloudnative/os-manager/next/en/references/seedimage-reference.html[SeedImage] resource.
