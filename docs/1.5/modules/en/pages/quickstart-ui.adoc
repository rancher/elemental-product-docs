...
RAW image only contains a boot and a recovery partition and it boots first into recovery mode to install SUSE® Rancher Prime OS Manager (for information, the process is similar to the link:reset#reset-workflow[reset] one).
