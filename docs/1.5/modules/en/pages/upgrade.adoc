...
All components in SUSE® Rancher Prime OS Manager are managed using Kubernetes. Below is how
to use Kubernetes approaches to upgrade the components.

== SUSE® Rancher Prime OS Manager node upgrade

SUSE® Rancher Prime OS Manager nodes are upgraded with the {elemental_operator_name}. Refer to the
...
image::upgrade-ui-menu.png[SUSE® Rancher Prime OS Manager Upgrade Menu]
...
image:upgrade-ui-os-version.png[SUSE® Rancher Prime OS Manager OS Version menu] 
