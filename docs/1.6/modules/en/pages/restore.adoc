...
Follow this guide to restore an SUSE® Rancher Prime OS Manager configuration from a backup with Rancher.
...
You first have to follow this xref:backup.adoc[documentation] to do a backup of SUSE® Rancher Prime OS Manager resources.

== Restore the SUSE® Rancher Prime OS Manager configuration with rancher-backup operator
