...
link:architecture-components#elemental-register-command-line-tool[SUSE® Rancher Prime OS Manager-register] is the first communication endpoint between the new host and Rancher Manager, this is the first place where proxy settings need to be set.
