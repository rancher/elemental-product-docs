 ...
 ** Hint 4: A minimum volume size of 25 GB is recommended. See the xref:installation.adoc#_deployed_partition_table[SUSE® Rancher Prime OS Manager partition table] for more details
