...
+
======
Pour installer à partir d'une archive https://github.com/rancherfederal/hauler-docs[Hauler] (`-ha` option dans `elemental-airgap.sh`), l'installation de Hauler est également une exigence sur l'hôte à partir duquel l'installation est effectuée. 
