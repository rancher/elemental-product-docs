...
+
======
To install from a https://github.com/rancherfederal/hauler-docs[Hauler] archive (`-ha` option in `elemental-airgap.sh`) Hauler installation is also a requirement on the host from where the installation is performed. 
