...
| v1.8.1
| https://github.com/rancher/elemental-operator/releases/tag/v1.8.1[Link]
...
The cloud-config defined in `MachineRegistrations` is not applying `after-install-chroot` stage in version v1.8.0. Currently fixed since v1.8.1.
