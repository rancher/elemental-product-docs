...
+
======
Um aus einem https://github.com/rancherfederal/hauler-docs[Hauler] Archiv zu installieren (`-ha` Option in `elemental-airgap.sh`), ist die Hauler-Installation auch eine Voraussetzung auf dem Host, von dem aus die Installation durchgeführt wird. 
