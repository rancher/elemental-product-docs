...
+
======
Para instalar desde un archivo https://github.com/rancherfederal/hauler-docs[Hauler] (`-ha` opción en `elemental-airgap.sh`), la instalación de Hauler también es un requisito en el host desde donde se realiza la instalación. 
