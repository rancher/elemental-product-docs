...
| v1.9.1
| https://github.com/rancher/elemental-operator/releases/tag/v1.9.1[Link]

| https://github.com/rancher/elemental-toolkit/[{elemental-product-name} Toolkit]
| v2.3.2
| https://github.com/rancher/elemental-toolkit/releases/tag/v2.3.2[Link]

| https://github.com/rancher/elemental[{elemental-product-name} Linux]
| v2.3.0
| https://github.com/rancher/elemental/releases/tag/v2.3.0[Link]
...
Since version v1.9.x Elemental Operator must be paired with Rancher v2.14.x or later. Kubernetes provisioning
is not functional otherwise, MachineInventory resources do not succeed when attempting to join an Elemental cluster.

=== SElinux in permissive mode

Setting SElinux in enforcing mode is not supported in v1.9.x Elemental.
