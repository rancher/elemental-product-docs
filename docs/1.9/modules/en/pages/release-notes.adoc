...
| v1.9.2
| https://github.com/rancher/elemental-operator/releases/tag/v1.9.2[Link]

| https://github.com/rancher/elemental-toolkit/[{elemental-product-name} Toolkit]
| v2.3.4
| https://github.com/rancher/elemental-toolkit/releases/tag/v2.3.4[Link]

| https://github.com/rancher/elemental[{elemental-product-name} Linux]
| v2.3.1
| https://github.com/rancher/elemental/releases/tag/v2.3.1[Link]
