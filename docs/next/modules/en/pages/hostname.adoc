...
the `MachineRegistration` xref:machineregistration-reference.adoc#_machinename[`machineName field`] should be set to the `${System Data/Runtime/Hostname}` Hardware Label.
