...
image::images/reset-cluster-deletion.png[Delete a Cluster to reset all machines]

. When managing a Cluster, simply delete the Node that needs to be reset

image::images/reset-single-node-deletion.png[Delete a single node to reset it]
